        ...
        body: SingleChildScrollView(
            ...
            child: Column(children: [
                      ...
                      Row(
                          ...
                          children: [
                            CustomImageView(
                                ...
                                width: 16.h,
                                margin:
                                    EdgeInsets.only(top: 1.v, bottom: 12.v)),
                            Expanded(
                                child: CustomTextFormField(
                                    readOnly: true,
                                    controller: snapshotController
                      ...
                      Row(
                          ...
                          children: [
                            CustomImageView(
                                ...
                                width: 15.adaptSize,
                                margin:
                                    EdgeInsets.only(top: 8.v, bottom: 13.v)),
                            Expanded(
                                child: CustomTextFormField(
                                    readOnly: true,
                                    controller: snapshotController
              ...
              Container(
                  ...
                  padding:
                      EdgeInsets.symmetric(horizontal: 12.h, vertical: 22.v),
                  decoration: AppDecoration.outlineBlack.copyWith(
                      borderRadius: BorderRadiusStyle.roundedBorder16),
                  child: Column(
                        ...
                        Row(
                            ...
                            children: [
                              CustomImageView(
                                  ...
                                  width: 17.h,
                                  margin:
                                      EdgeInsets.only(top: 1.v, bottom: 13.v)),
                              Expanded(
                                  child: CustomTextFormField(
                                      readOnly: true,
                                      controller: snapshotController
                        ...
                        Row(
                            ...
                            children: [
                              CustomImageView(
                                  ...
                                  width: 15.adaptSize,
                                  margin:
                                      EdgeInsets.only(top: 7.v, bottom: 13.v)),
                              Expanded(
                                  child: CustomTextFormField(
                                      readOnly: true,
                                      controller: snapshotController
