                        ...
                        children: [
                          ...
                          Expanded(
                            child: CustomTextFormField(
                              ...
                              controller: signUpController.aptController.value,
                              margin: EdgeInsets.only(left: 22.h),
                              labelText: "Apt Ste",
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: CustomTextFormField(
                              ...
                              controller:
                                  signUpController.businessNameController.value,
                              margin: EdgeInsets.only(left: 22.h),
                              ...
                              Obx(
                                () => Row(children: [
                                  CustomRadioButton(
                                    ...
                                    value: "English",
                                    groupValue:
                                        signUpController.selectedlanguage.value,
                                    onChange: (value) {
                                      signUpController.languageSelected(value);
                                    },
                                  ),
                                  SizedBox(width: 20.h),
                                  CustomRadioButton(
