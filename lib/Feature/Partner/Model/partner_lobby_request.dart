class PartnerDashboardLobbyConnectionModel {
  List<Services>? services;

  PartnerDashboardLobbyConnectionModel({this.services});

  PartnerDashboardLobbyConnectionModel.fromJson(Map<String, dynamic> json) {
