class PartnerDashboardLobbyExpiredModel {
  List<Services>? services;

  PartnerDashboardLobbyExpiredModel({this.services});

  PartnerDashboardLobbyExpiredModel.fromJson(Map<String, dynamic> json) {
